            ...
            <ul class="navbar-nav mr-auto my-navbar">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-content" aria-labelledby="navbarDropdown">
                  <a class="dropdown-item cambio" href="{{route('catalogo')}}"><i class="fas fa-book"></i> Categorias</a>
                  <a class="dropdown-item cambio" href="#"><i class="fas fa-plus"></i> Nueva Categoria</a></div>
              </li>
              <li class="nav-item dropdown">
                <a class="nav-link cambio" href="#!" id="navbarDropdown" role="button" data-toggle="dropdown" style="color: black;">
                  Productos
                ...
                <div class="dropdown-menu dropdown-content" aria-labelledby="navbarDropdown">
                  <a class="dropdown-item cambio" href="#!"><i class="fas fa-tshirt"></i> Productos</a>
                  <a class="dropdown-item cambio" href="#!"><i class="fas fa-plus"></i> Nuevo Producto</a></div>
              </li>
              <li class="nav-item dropdown">
                <a class="nav-link cambio" href="#!" id="navbarDropdown" role="button" data-toggle="dropdown" style="color: black;">
                  Usuarios
                ...
                <div class="dropdown-menu dropdown-content" aria-labelledby="navbarDropdown">
                  <a class="dropdown-item cambio" href="#!"><i class="fas fa-user"></i> Usuarios</a>
                  <a class="dropdown-item cambio" href="#!"><i class="fas fa-plus"></i> Nuevo Usuario</a></div>
              </li>
            </ul>
            <ul class="navbar-nav ml-auto">
              <li class="nav-item">
                <a class="nav-link cambio" href="#!"><i class="fas fa-sign-out-alt"></i> Salir</a>
              </li>
              <li class="nav-item">
    ...
    <div class="col">
      <nav class="navbar navbar-dark bg-dark navi">
        ...
        <div class="col-lg-2">
          ...
          <a href="#!" class="cambio-f">Usuarios</a><br>
        </div>
        <div class="col-lg-4">
          <h5>Siguenos</h5>
